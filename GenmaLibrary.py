...
def SMSFreemobile(texte_du_sms):
    ...
    try :
        ...
        resultatFonction = e
    #print "User : " + userFreemobile
    #print "Pass : " + passFreemobile
    #print "Texte : " + texte_du_sms
    #print "Lecture du fichier de config réussi"
...
def EnvoiTwitt(messageDuTwitt):
    ...
    try :
        ...
        for i in range(0, multiple):
            ...
            #---------------------------------------"
            #print(len(messageDuTwitt[debutChaineCourante:finChaineCourante]))
            debutChaineCourante = finChaineCourante
            #print("Prochain debut " + str(debutChaineCourante))
            if finChaineCourante + 140 < len(messageDuTwitt):
                finChaineCourante = finChaineCourante + 140
            else:
                finChaineCourante = len(messageDuTwitt)
            #print(finChaineCourante)
    except IOError, e:
        resultatFonction = e
    #resultatFonction = "C'est fini"
    return resultatFonction
#message = """Test Python : Ceci est un message très long que j'envoie via l'API de Twitter et donc ça doit le couper en plusieurs morceaux. C'est ce qu'on va voir. Je teste ça de suite. Si ça s'affiche, c'est que ça marche !!!"""
#message2 = "Test Python, Message plus court"
#message3 = """Là le script python doit couper proprement mais surtout ajouter un compteur de nombres de twitts pour qu'on sache où on est. Ca doit se faire tout seul, on vérifie ça ;)"""
#print(EnvoiTwitt(message3))
...
def DernierBilletDsRSSBlog():
    ...
    for i in range(0, syndication_number):
    	...
    	#print ("Titre : " + articleTitle + " URL : " + urlToShorten )
